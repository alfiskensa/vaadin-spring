package com.example.myavaadin.security;

import com.example.myavaadin.service.UIService;
import com.example.myavaadin.springview.LoginView;
...
public class VaadinAccessDecisionManager implements AccessDecisionManager {
    ...
    public static final UIService UI_SERVICE = new UIService();
